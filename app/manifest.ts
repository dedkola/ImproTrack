    ...
    screenshots: [
      {
        ...
        sizes: "2630x1582",
        type: "image/png",
        label: "Habit dashboard with weekly progress and check-in cells",
      },
      {
        src: "/brand/stats-shot.png",
        sizes: "2632x1526",
        type: "image/png",
        label: "Statistics dashboard with streak summaries and trend charts",
      },
      {
        src: "/brand/global-statistic.png",
        sizes: "3336x1814",
        type: "image/png",
        label: "Global statistics view with completion summaries and progress insights",
      },
    ],
